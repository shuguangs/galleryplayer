...
| **medium** | ~1.5GB | **x8.4 实时率** | 准确 | **推荐（性价比）** |
| large-v3 | ~3GB | x6.3 实时率 | 最准 | 追求精读（加载慢 38s） |

### 翻译（Ollama 模型，实测多语言 → 中文 6/6 通过）

| 模型 | 体积 | 短句延迟 | 长句/术语 | 适合 |
|---|---|---|---|---|
| qwen2.5:3b | 2.1GB | <0.2s | 一般 | 省资源/日常对话 |
| **qwen2.5:7b** | 3.8GB | <0.2s | 更准 | **推荐**（医疗/专业内容） |

> 多语言验证：日/韩/西/法/德/英 → 中文全部翻译自然准确（qwen 原生多语支持）
